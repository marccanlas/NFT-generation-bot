...
BASE_IMAGE_URL = "ipfs"
BASE_NAME = "Cricket Moonshot #"

BASE_JSON = {
    "name": BASE_NAME,
    "description": "A unique set of Koala NFTs from The Cricket Moonshot collection. Grab your NFTs now as we unveil their exciting utilities, which may include both gaming & real-world utilities.",
